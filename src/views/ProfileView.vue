        ...
        <div class="px-6 pb-6 relative">
          ...
          <div class="absolute -top-16 left-6 z-20">
            <img
              :src="
                userProfile.avatar ||
                'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=facearea&facepad=3&w=64&h=64&q=80'
              "
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p class="text-gray-600">
                  {{ userProfile.year || 'N/A' }} • {{ userProfile.major || 'N/A' }}
                </p>
                <p class="text-sm text-gray-500 mt-1">
                  Joined {{ userProfile.joinedDate ? formatDate(userProfile.joinedDate) : 'N/A' }}
                </p>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
              ...
              <div>
                ...
                <div class="space-y-1">
                  ...
                  <p
                    v-if="!userProfile.coursesEnrolled || userProfile.coursesEnrolled.length === 0"
                  ...
                  <div class="flex-1">
                    ...
                    <div class="flex space-x-4 mt-3 text-sm text-gray-500">
                      ...
                      >
                        <svg
                          class="w-4 h-4"
                          :class="post.isLiked ? 'text-red-600 fill-current' : ''"
                          fill="none"
                          stroke="currentColor"
                          stroke-width="2"
                          viewBox="0 0 24 24"
          ...
          <div class="bg-white rounded-lg shadow p-6">
            <div class="flex justify-between items-center mb-4">
              ...
              <span class="text-sm text-gray-500"
                >{{ (userProfile.friends || []).length }} friends</span
              >
            </div>
            <div class="grid grid-cols-3 gap-3">
              <div
                v-for="friend in (userProfile.friends || []).slice(0, 9)"
                :key="friend.id"
                class="text-center"
              >
                <img
            ...
            <div
              v-if="!userProfile.friends || userProfile.friends.length === 0"
      ...
      friends: [
        {
          ...
          name: 'Sarah Chen',
          avatar:
            'https://images.unsplash.com/photo-1494790108755-2616b612b5bc?auto=format&fit=facearea&facepad=3&w=64&h=64&q=80',
        },
        {
          id: 2,
          name: 'Mike Johnson',
        ...
        },
        {
          ...
          name: 'Emma Wilson',
          avatar:
            'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?auto=format&fit=facearea&facepad=3&w=64&h=64&q=80',
        },
        {
          id: 4,
          name: 'John Smith',
          avatar:
            'https://images.unsplash.com/photo-1527980965255-d3b416303d12?auto=format&fit=facearea&facepad=3&w=64&h=64&q=80',
        },
        {
          id: 5,
          name: 'Lisa Park',
          avatar:
            'https://images.unsplash.com/photo-1500522144261-ea64433bbe27?auto=format&fit=facearea&facepad=3&w=64&h=64&q=80',
        },
        {
          id: 6,
          name: 'David Kim',
          avatar:
            'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=facearea&facepad=3&w=64&h=64&q=80',
        },
      ],
    }
  } else {
  ...
  userPosts.value = [
    {
      id: 1,
      content:
        'Just finished implementing a neural network from scratch! The mathematics behind backpropagation is fascinating.',
      ...
      comments: [
        {
          ...
          content: 'That sounds amazing! Can you share some resources?',
          createdAt: new Date('2025-08-14T16:00:00'),
        },
      ],
      showComments: false,
    },
    {
      id: 2,
      content:
        "Excited to start my internship at Google this summer! Can't wait to work on real-world projects.",
      ...
      comments: [
        {
          ...
          content: 'Congratulations! Google is amazing!',
    ...
    },
    {
      id: 3,
      content:
        'Study group for Advanced Algorithms tomorrow at 2 PM in the library. Everyone welcome!',
