    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500" @click="handleForgotPassword">Forgot your password?</a>
          </div>
        </div>
        ...
        <div class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
          ...
          <p class="text-xs text-blue-700">You can use any email and password to log in to the demo.</p>
...
const fillDemoCredentials = () => {
  form.email = 'demo@university.edu'
